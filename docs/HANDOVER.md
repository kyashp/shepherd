...
| `ST-02` | Stored notification values remain visible, but native disabled controls label the unimplemented capability **Reserved** and **Unavailable**. The focused RED/GREEN regression and terminal Chromium rehearsal at both required viewports passed without mutation, focus, PATCH, overflow, clipping, or runtime errors. | [Draft PR #13](https://github.com/kyashp/shepherd/pull/13), integrated with `origin/main` at `349897d3d9167fe711bf720f7c3fadd213938d11` | Fresh integrated full gate, final browser screenshots, independent review, required checks, merge, and post-merge verification. |
