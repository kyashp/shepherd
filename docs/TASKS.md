...
| `PERF-01` | 14 | `BLOCKED` by [#41](https://github.com/kyashp/shepherd/issues/41); [issue #46](https://github.com/kyashp/shepherd/issues/46); issue #43 dependency completed at `fbc937f` | Measure persisted event → visible `<=1.5s`, Plane creation, verification, candidate overlap, collision-to-promotion and total demo time; record method/sample/limits. `B,I`. | **10%**; 0/2; not audited |
