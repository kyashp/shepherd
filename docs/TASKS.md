...
|---|---|---|---|---|
| `E2E-HARNESS` | 0.4, 16 Phase 6 | `READY` after `TST-02` | Commit Playwright config, repo-local deterministic startup, isolated state and fake Codex CLI; never read `.env` or expose production debug routes. `T,C,B,S,I`. | **0%**; 0/5; not audited |
