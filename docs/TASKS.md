...
|---|---|---|---|---|
| `MR-03` | 8.6, 12 | `LOCAL_AUDIT_CANDIDATE`; TST-08 correction awaits Auditor integration | PR #25 merged to `main` as `5b8f835`; local conflict-free merge is `3c878b3` on `audit/tst-08-mr03-cleanup` | Focused deterministic gates pass with the TST-08 fixture correction, but Auditor integration and the single final live reviewer request remain pending. |
...
| `MR-01` | 4.1.13, 8.6, 12 | Integrated/provider-free audited at `577255e`; blocked by external `MR-03` and final `L` | The bounded reviewer consumes only trusted verified summaries/evidence refs, validates schema and refs, records advisory/degraded evidence, and never changes deterministic collision/candidate/promotion authority. Independent provider-free matrices, adjacency, browser, security, literal and hosted gates passed. Validate partial findings through MR-03, then make exactly one bounded live reviewer call. | **90% scoped**; `T,A,C,B,S,U,I` passed (7/8); `L` pending; not final audited |
